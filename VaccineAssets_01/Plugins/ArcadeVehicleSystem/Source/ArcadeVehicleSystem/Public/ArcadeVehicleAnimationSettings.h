...
struct FVehicleWheelAnimationInfo
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct FVehicleAnimationWheelsSettings
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct FVehicleAnimationTiltSettings
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct FVehicleAnimationRollSettings
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct FVehicleAnimationSettings
{
	GENERATED_BODY()
