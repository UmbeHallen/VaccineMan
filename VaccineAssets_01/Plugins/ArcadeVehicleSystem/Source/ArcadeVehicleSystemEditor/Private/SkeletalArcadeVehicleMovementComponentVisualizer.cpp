...
void FSkeletalArcadeVehicleMovementComponentVisualizer::DrawVisualization(const UActorComponent* Component, const FSceneView* View, FPrimitiveDrawInterface* PDI)
{
	/* Cache currently visualized component. */
	const UArcadeVehicleMovementComponent* pVehicleMovement = Cast<UArcadeVehicleMovementComponent>(Component);
